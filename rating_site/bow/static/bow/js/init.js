...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			'global':	{ range: '*', href: '/static/bow/css/style.css', containers: 1140 },
			'wide':		{ range: '-1680', href: '/static/bow/css/style-wide.css', containers: 960 },
			'normal':	{ range: '-1080', href: '/static/bow/css/style-normal.css', containers: '95%', viewport: { scalable: false } },
			'narrow':	{ range: '-840', href: '/static/bow/css/style-narrow.css', grid: { gutters: 30 } },
			'mobile':	{ range: '-640', href: '/static/bow/css/style-mobile.css', grid: { collapse: true, gutters: 20 } }
		}
	});
